/* ============================================================================
   ...
   high-value thinness (C). Numbers aligned to the demo narrative — 30K policies
   tested, $19.3M NWP protected at Strategy A defaults.
...
const retentionSignals = [
  {
    ...
    statement: {
      who: '30K high-LTV auto customers · claims-free · shopping their renewal.',
    ...
    kpis: [
      { kind: 'scale',  label: 'Scope',         value: '30K',       unit: 'eligible policies',                        context: 'after fair-lending filter' },
      { kind: 'gate',   label: 'Fairness gate', value: '≥0.70',     unit: 'sticky-bundled filter',                    context: 'audit-defensible basis' },
      { kind: 'stakes', label: 'Stakes (est.)', value: '+$15–25M',  unit: 'NWP protected / yr · est. range',          context: '−2.3pp lapse rate' },
    ],
  ...
  },
  {
    ...
    statement: {
      who: '22K customers · digital engagement weakening · coverage questions rising · not yet shopping.',
    ...
    kpis: [
      { kind: 'scale',  label: 'Scope',         value: '22K',     unit: 'customers showing engagement decay',      context: 'before shopping starts' },
      { kind: 'gate',   label: 'Trigger',       value: '60d',     unit: 'decay window',                            context: 'pre-shopping intervention' },
      { kind: 'stakes', label: 'Stakes (est.)', value: '+$8–14M', unit: 'NWP protected / yr · est. range',         context: 'no rate concession needed' },
    ],
  ...
  },
  {
    ...
    statement: {
      who: '3K high-value households · LTV over $12K · top of the shopping-risk list.',
    ...
    kpis: [
      { kind: 'scale',  label: 'Scope',         value: '3K',      unit: 'high-value households',                context: 'LTV over $12K' },
      { kind: 'gate',   label: 'LTV',           value: '≥$12K',   unit: 'minimum household LTV',                context: 'relationship economics work here' },
      { kind: 'stakes', label: 'Stakes (est.)', value: '+$6–10M', unit: 'NWP protected / yr · est. range',      context: 'small cohort, high per-household value' },
    ],
