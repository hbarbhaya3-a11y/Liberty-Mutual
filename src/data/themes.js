...
export const INTERNAL_THEMES = [
  ...
  { id: "smbrate", type: "Account Opportunity · Small Commercial", name: "High-value accounts in play at renewal", obj: "ret", status: "spiking", valueM: 54, vq: "account NWP in play", count: 412, vel: 7, conf: 85, urg: 0.80, desc: "Specific in-force accounts signaling shopping and non-renewal risk — each a defend-and-deepen opportunity worth acting on now, with no adverse loss trend. Open an account to run the guided renewal simulation: signal → goals & guardrails → levers → recommended action.", macro: "Rate-hardening cycle · insurtech & competitor renewal offers", b2b: true, pinned: true, pinOrder: 5 },
...
export const INTERNAL_SIGS = [
  ...
  ["#ff6b6b", "Account in play · broker requesting competitor quote", "renewal-feed", "smbrate"],
  ["#ffb15a", "High-value account · non-renewal notice modeled", "renewal-monitor", "smbrate"],
