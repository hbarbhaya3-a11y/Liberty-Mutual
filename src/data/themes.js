...
export const INTERNAL_THEMES = [
  ...
  { id: "smbgrowth", type: "Growth Signal · Commercial", name: "Small-fleet commercial auto expansion", obj: "deep", status: "spiking", valueM: 46, vq: "annual premium opportunity", count: 384, vel: 8, conf: 82, urg: 0.75, desc: "38,400 small businesses adding vehicles and drivers — 61% currently insured off-us. A short window to win the commercial-auto and BOP relationship as fleets grow.", macro: "SMB expansion cycle · commercial-lines competition", b2b: true, pinned: true, pinOrder: 4 },
  { id: "smbrate", type: "Retention Risk · Commercial", name: "Rate-sensitive commercial auto", obj: "ret", status: "spiking", valueM: 54, vq: "premium exposure", count: 412, vel: 7, conf: 85, urg: 0.80, desc: "41,200 commercial-auto policies showing early shopping after rate action — $3.4B premium being courted away, with clean loss experience. Defend at the lowest rate that works.", macro: "Commercial-auto rate-hardening · competitor promos", b2b: true, pinned: true, pinOrder: 5 },
  ...
  { id: "limits", type: "Coverage-Gap Signal", name: "Underinsured liability limits", obj: "deep", status: "emerging", valueM: 210, vq: "coverage opportunity", count: 96, vel: 3, conf: 58, urg: 0.35, desc: "Rising asset values on growing households signal a need for higher liability limits and umbrella.", macro: "Litigation-severity inflation" },
  ...
  { id: "moneymoment", type: "Bundle-Moment Acquisition", name: "Bundle attach at property purchase",   obj: "acq", status: "spiking",       valueM: 12.4, vq: "est. annual bundle-attach value pool",      count: 98,  vel: 7, conf: 66, urg: 0.80, desc: "Home purchase, mortgage closing and address change identify households at a high-intent bundle moment — attach home + auto when the property is already moving.", macro: "Home-purchase money-in-motion" },
  ...
  { id: "relsave",     type: "Relationship Save",      name: "Claims-experience churn risk",           obj: "ret", status: "confirmed",     valueM: 9.3,  vq: "est. annual relationship-save value pool",   count: 209, vel: 6, conf: 82, urg: 0.70, desc: "Long claim cycle-time, low post-settlement NPS and repeat service friction mark relationships sliding toward lapse — intervene with the lowest-cost save action before the renewal.", macro: "Claims-friction & service dissatisfaction" },
  ...
  { id: "cardret",     type: "Coverage Retention",     name: "Coverage down-shift drift",             obj: "ret", status: "strengthening", valueM: 3.0,  vq: "est. annual coverage-defense value pool",   count: 147, vel: 6, conf: 76, urg: 0.55, desc: "Deductible increases, optional-coverage drops and mid-term reductions show policies thinning toward a competitor quote — size the save offer to the premium actually at risk.", macro: "Price-driven coverage migration" },
];
...
export const INTERNAL_SIGS = [
  ...
  ["#4fd1c5", "New vehicle added to commercial fleet", "policy-admin", "smbgrowth"],
  ["#5b9dff", "Business expansion + new driver · commercial", "biz-records", "smbgrowth"],
  ["#ff6b6b", "Commercial-auto shopping · quote velocity −12%", "shopping-feed", "smbrate"],
  ["#ffb15a", "Large fleet + partial non-renewal · rate-shopping", "portfolio-monitor", "smbrate"],
  ...
  ["#5b9dff", "Liability limit below asset value · household", "underwriting", "limits"],
  ["#5b9dff", "Umbrella gap flagged · 2nd this quarter", "underwriting", "limits"],
