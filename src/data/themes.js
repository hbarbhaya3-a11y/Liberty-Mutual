...
export const INTERNAL_THEMES = [
  ...
  { id: "smbgrowth", type: "Growth Signal · B2B", name: "SMBs entering an expansion cycle", obj: "deep", status: "spiking", valueM: 46, vq: "annual revenue opportunity", count: 384, vel: 8, conf: 82, urg: 0.75, desc: "38,400 small businesses showing growth-and-financing signals — 61% currently financing or processing off-us. A short window to win back the credit and payments leaving the relationship.", macro: "SMB expansion cycle · fintech & competitor financing", b2b: true, pinned: true, pinOrder: 4 },
...
export const INTERNAL_SIGS = [
  ...
  ["#4fd1c5", "New off-us small-biz card · acquirer change", "merchant-acquirer", "smbgrowth"],
  ["#5b9dff", "Real-estate expansion + rising recurring cost · SMB", "biz-ledger", "smbgrowth"],
