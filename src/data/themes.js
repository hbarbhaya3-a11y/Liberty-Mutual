...
export const INTERNAL_THEMES = [
  ...
  { id: "smbrate", type: "Renewal Risk · Small Commercial", name: "Rate-sensitive renewals shopping at renewal", obj: "ret", status: "spiking", valueM: 54, vq: "NWP at risk", count: 412, vel: 7, conf: 85, urg: 0.80, desc: "41,200 Small Commercial renewals showing early shopping and non-renewal signals — $3.4B in-force premium being courted away on rate, with no adverse loss trend. Defend retention at the lowest adequate rate.", macro: "Rate-hardening cycle · insurtech & competitor renewal offers", b2b: true, pinned: true, pinOrder: 5 },
...
export const INTERNAL_SIGS = [
  ...
  ["#ff6b6b", "Renewal shopping · broker requesting competitor quote", "renewal-feed", "smbrate"],
  ["#ffb15a", "In-force account + non-renewal notice · rate-shopping", "renewal-monitor", "smbrate"],
