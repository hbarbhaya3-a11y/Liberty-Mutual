                ...
                <div key={i} style={{ borderBottom: "1px solid var(--hair)" }}>
                  ...
                  >
                    ...
                    {r.convPct != null ? (
                      ...
                      <>
                        {!hideRateCap && <span className="seg-td seg-col-num seg-offer">{r.noRate ? "—" : <span className="seg-offer-bps" style={{ color: "var(--green)" }}>{r.productId === "cd_6mo" ? (r.rate || (r.rateBps ? `${r.rateBps} bps` : "—")) : (r.dollarOff ? `$${r.dollarOff}` : "—")}</span>}</span>}
